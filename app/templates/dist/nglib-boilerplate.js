/**
 * nglib-boilerplate - v0.0.2 - 2014-12-22
 * http://github.com/cork-labs/nglib-boilerplate
 *
 * Copyright (c) 2014 Cork Labs <http://cork-labs.org/>
 * License: MIT <http://cork-labs.mit-license.org/>
 */
angular.module('my.module.templates', []).run(['$templateCache', function($templateCache) {
$templateCache.put("lib/my.module/my.division.tpl.html",
"<div class=\"my-module my.division\">{{ngModel}} / {{divisor}} = {{divide(ngModel)}}</div>");
}]);
